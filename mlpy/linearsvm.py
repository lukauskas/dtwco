...
class LinearSVC:
    """Linear SVM Classifier implementing one-vs-the rest
    multi-class strategy.
    """

    SOLVER_TYPE = {
        "l2r_l2loss_dual": "l2r_l2loss_svc_dual",
        "l2r_l2loss": "l2r_l2loss_svc",
        "l2r_l1loss_dual": "l2r_l1loss_svc_dual",
        "l1r_l2loss": "l1r_l2loss_svc"
        }
    
    def __init__(self, solver_type='l2r_l2loss_dual', C=1, eps=0.01, weight={}):
        """Initialization.

        :Parameters:
            solver_type : string
                solver, can be one of 'l2r_l2loss_dual', 'l2r_l2loss'
                (L2-regularized L2-loss), 'l2r_l1loss_dual', (L2-regularized
                L1-loss) and 'l1r_l2loss' (L1-regularized L2-loss).
            C : float
